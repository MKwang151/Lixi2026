...
const photos: Photo[] = [
  { id: 1, src: "/img/1.jpg", caption: "Sinh nhật đầu tiên có em tổ chức, anh suýt khóc luôn á 🎂🥹" },
  { id: 2, src: "/img/2.jpg", caption: "Lần đầu tặng quà cho người mình thương bây lâu 🎁🥰 " },
  { id: 3, src: "/img/3.jpg", caption: "Năm nay sinh nhật lại có em, anh giàu nhất rồi 🎉💰" },
  { id: 4, src: "/img/4.jpg", caption: "365 ngày yêu em — mỗi ngày đều muốn quay lại từ đầu 💍🥰" },
  { id: 5, src: "/img/5.jpg", caption: "8/3 đi công viên, em cười một cái là anh quên hết mệt 🌸😍" },
  { id: 6, src: "/img/6.jpg", caption: "Sinh nhật công chúa nhỏ, anh chỉ ước em mãi cười thế này 🎀😍" },
  { id: 7, src: "/img/7.jpg", caption: "20/10 lúc anh yếu đuối nhất vẫn có em bên cạnh 🥹❤️" },
  { id: 8, src: "/img/8.jpg", caption: "Sinh nhật anh 2026 — món quà lớn nhất vẫn là có em 🎂💝" },
];
